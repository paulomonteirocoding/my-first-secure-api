...
CREATE TABLE IF NOT EXISTS `supplier_order_products` (
  `id` integer PRIMARY KEY,
...
ALTER TABLE `supplier_order_products` ADD FOREIGN KEY (`order_id`) REFERENCES `supplier_orders` (`id`);

ALTER TABLE `supplier_order_products` ADD FOREIGN KEY (`SKU`) REFERENCES `products` (`SKU`);

ALTER TABLE `supplier_orders` ADD FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`);
